...
ames_map.save('./map/ames_map.html')
# ================================================================
import folium
...
# 결과를 HTML 파일로 저장
ames_map.save('./map/top_2_houses_map.html')
...
my_map.save("./map/map_with_final.html")
...
# 맵 저장
my_map.save("./map/map_with_text.html")
...
my_map.save("../map/house1015_Overall.html")
...
# 맵 저장
my_map2.save("./map/map2_with_text.html")
...
# 지도를 HTML 파일로 저장하거나 노트북에서 바로 표시
my_map2.save("./map/house1015_GrLivArea.html")
...
# 맵 저장
my_map3.save("../map/map3_with_text.html")
...
# 지도를 HTML 파일로 저장하거나 노트북에서 바로 표시
my_map3.save("./map/house1015_year_remod.html")
...
# 맵 저장
my_map4.save("./map/map4_with_text.html")
...
# 지도를 HTML 파일로 저장하거나 노트북에서 바로 표시
my_map4.save("./map/house1015_Year_Built.html")
...
my_map.save("./map/top_6_houses.html")
...
# 6. 맵 저장
my_map.save("./map/my_map_top6.html")
...
# 지도를 HTML 파일로 저장하거나 IPython 환경에서 표시
my_map.save("./map/top_2_houses_map.html")
